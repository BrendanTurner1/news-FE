...
export default function Article({ article }) {
    ...
    return (
        <div className="article">
            ...
            {article.urlToImage ? <img className="article-img"src={article.urlToImage} alt={article.title}></img> : <img className="img-not-found"src={"https://media1.tenor.com/m/lx2WSGRk8bcAAAAC/pulp-fiction-john-travolta.gif"}></img>}
